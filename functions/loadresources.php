...
if(isset($_GET['adminDB'])){
	...
	try{
		...
		if($doc->legacy->type=='mp3'){
			   ...
			   </a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='delete.php?database=resources&resid=".$doc->_id."' target='_blank' class='btn btn-lg btn-primary glyphicon glyphicon-trash'>Delete</a></td>");
		   }
			...
			<a href='delete.php?database=resources&resid=".$doc->_id."' target='_blank'  class='btn btn-lg btn-primary glyphicon glyphicon-trash'></a></td>");
		   }
		   else{
			   print("<td><a href='viewResource.php?database=ttel_resources&resid=".$doc->_id."' target='_blank'  class='btn btn-lg btn-warning glyphicon glyphicon-book'></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='delete.php?database=resources&resid=".$doc->_id."' target='_blank'  class='btn btn-lg btn-primary glyphicon glyphicon-trash'></a></td>");
		   }
		  echo "</tr>
	   '";
...
//		  echo "</td>";
						///	echo "</td>";
							if($doc->legacy->type=='mp3'){
								 print("<td><a href='viewResource.php?database=resources&resid=".$doc->_id."' target='_blank' class='btn btn-lg btn-success glyphicon glyphicon-music'></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								 <a href='delete.php?database=resources&resid=".$doc->_id."' target='_blank' class='btn btn-lg btn-primary glyphicon glyphicon-trash'>Delete</a></td>");
							 }
							 else if($doc->legacy->type=='mp4'||$doc->legacy->type=='avi'||$doc->legacy->type=='flv'){
 							  print("<td><a href='viewResource.php?database=resources&resid=".$doc->_id."' target='_blank'  class='btn btn-lg btn-info glyphicon glyphicon-facetime-video'></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							  <a href='delete.php?database=resources&resid=".$doc->_id."' target='_blank'  class='btn btn-lg btn-primary glyphicon glyphicon-trash'></a></td>");
							 }
							 else{
								 print("<td><a href='viewResource.php?database=resources&resid=".$doc->_id."' target='_blank'  class='btn btn-lg btn-warning glyphicon glyphicon-book'></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								 <a href='delete.php?database=resources&resid=".$doc->_id."' target='_blank'  class='btn btn-lg btn-primary glyphicon glyphicon-trash'></a></td>");
							 }
							echo "</tr>
						 '";
